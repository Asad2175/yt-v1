      ...
      <section>
        <div className="container">
          ...
          <div className="mx-auto des">
            ...
            <div className="mb-5">
              <h2 className="fw-bold mb-3">Interpretation and Definitions</h2>
            ...
            <div className="mb-5">
              ...
              <h3 className="fw-bold mb-3">Types of Data Collected</h3>
              <h4 className="fw-bold mb-2">Personal Data</h4>
              <p>
              ...
              <h4 className="fw-bold mb-2">Usage Data</h4>
              <p>
              ...
              <h3 className="fw-bold mb-2">Use of Your Personal Data</h3>
              <p>
              ...
              <h3 className="fw-bold mb-2">Retention of Your Personal Data </h3>
              <p>
              ...
              <h3 className="fw-bold mb-2">Transfer of Your Personal Data </h3>
              <p>
              ...
              <h3 className="fw-bold mb-2">Delete Your Personal Data</h3>
              <p>
              ...
              <h3 className="fw-bold mb-2">Disclosure of Your Personal Data</h3>
              <h4 className="fw-bold mb-2">Business Transactions</h4>
              <p>
              ...
              <h4 className="fw-bold mb-2">Law enforcement</h4>
              <p>
              ...
              <h4 className="fw-bold mb-2">Other legal requirements </h4>
              <p>
              ...
              <h3 className="fw-bold mb-2">Security of Your Personal Data </h3>
              <p>
            ...
            <div className="mb-5">
              <h2 className="fw-bold mb-3">Children's Privacy</h2>
              <p>
            ...
            <div className="mb-5">
              <h2 className="fw-bold mb-3">Links to Other Websites</h2>
              <p>
            ...
            <div className="mb-5">
              <h2 className="fw-bold mb-3">Changes to this Privacy Policy</h2>
              <p>
