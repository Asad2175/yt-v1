export default function TermsOfUse() {
  return (
    <>
      <section className="py-5 footer-page">
        <div className="container">
          ...
          <div className="mb-4">
            ...
            <h3 className="fw-bold mb-2">Interpretation</h3>
            <p>
            ...
            <h3 className="fw-bold mb-2">Definitions </h3>
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Country refers to: </strong>Pakistan
                </p>
              </li>
              <li>
                <p>
                  <strong>Company </strong>refers to TikTok Video Downloader.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website </strong>refers to TikTok Video Downloader,
                  accessible from https://ttmp3.io
                </p>
              </li>
              <li>
                <p>
          ...
          <div className="mb-4">
            ...
            <h3 className="fw-bold mb-2">Severability</h3>
            <p>
            ...
            <h3 className="fw-bold mb-2">Waiver</h3>
            <p>
